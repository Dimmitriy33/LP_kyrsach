...
#pragma region FULLEQUALS

#define FST_FULLEQUALS FST::FST(2,\
FST::NODE(1, FST::RELATION('^', 1)),\
FST::NODE())

#pragma endregion

#pragma region NOTFULLEQUALS

#define FST_NOTFULLEQUALS FST::FST(2,\
FST::NODE(1, FST::RELATION('&', 1)),\
FST::NODE())

#pragma endregion

#pragma region SQUARE_CLOSE

#define FST_SQUARE_CLOSE FST::FST(2,\
FST::NODE(1, FST::RELATION(']', 1)),\
FST::NODE())

#pragma endregion

#pragma region SQUARE_OPEN

#define FST_SQUARE_OPEN FST::FST(2,\
FST::NODE(1, FST::RELATION('[', 1)),\
FST::NODE())
