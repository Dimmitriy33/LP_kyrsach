...
#define IN_CODE_TABLE {\
	...
	IN::S, IN::F, IN::F, IN::F, IN::O, IN::O, IN::O, IN::Q, IN::O, IN::O, IN::O, IN::O, IN::O, IN::O, IN::F, IN::O, \
	IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::F, IN::O, IN::O, IN::O, IN::O, IN::F, \
	IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, \
	IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::T, IN::F, IN::T, IN::O, IN::F, \
